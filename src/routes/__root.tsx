...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NHcard — мониторинг зарубежных виртуальных карт" },
      {
        name: "description",
        content:
          "Независимый мониторинг зарубежных виртуальных карт: тарифы, пополнение, комиссии и курс.",
      },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Onest:wght@400;500;600;700&display=swap",
      },
    ],
  }),
