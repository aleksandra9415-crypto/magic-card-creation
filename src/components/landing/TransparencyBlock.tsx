...
export default function TransparencyBlock({
  ...
  return (
    <section className="lp-transp transp-card" id="transparency" aria-labelledby="transparency-title" style={{ padding: 0, background: 'none', border: 'none', boxShadow: 'none' }}>
      <div className="transp-card" style={{ margin: 0 }}>
