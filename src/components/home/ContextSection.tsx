...
export default function ContextSection() {
  return (
    <SectionWrapper
      id="context"
      centered
      eyebrow="Контекст 2026"
      title="Почему российские карты не работают и что приходит на замену"
      description="Короткое объяснение для тех, кто оформляет зарубежную карту впервые. Если уже разбираетесь — пролистайте."
    >
      <div className="ctx grid-spacing">
        <div className="ctx-card card-padding">
